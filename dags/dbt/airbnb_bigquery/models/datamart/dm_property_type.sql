...
WITH
  facts_listings AS
    (SELECT
      *,
      ...
      PERCENTILE_CONT(CASE WHEN has_availability = 't' THEN price END, 0.5) OVER () AS median_active_listing_price,
  ...
  ,agg_data AS
    (SELECT
      ...
      MIN(median_active_listing_price) AS median_active_listing_price,
